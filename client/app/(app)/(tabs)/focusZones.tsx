    ...
    switch (key) {
        case "noise_level":
            ...
            if (typeof value === "number") {
                ...
                else if (value < 60) description = "Moderate noise (normal conversation)";
        ...
        case "headphones":
            ...
            if (typeof value === "boolean") {
                ...
                displayValue = typeof value === "number" ? value.toFixed(0) : String(value);
            }
            break;
        case "ventilation":
            icon = "fan";
...
const FocusZonesScreen = () => {
    ...
    const fetchFocusZones = async () => {
        ...
        try {
            ...
            const errorMessage = error.response?.data?.error || "Failed to fetch recommendations. Please try again.";
                    ...
                    <View style={styles.recommendationsContainer}>
                        ...
                        {recommendationsData.recommendations ? (
                            <ScrollView style={styles.recommendationsList}>
                                {Object.entries(recommendationsData.recommendations).map(([key, value]) => {
                                    const { icon, displayValue, description } = getRecommendationDetails(key, value);
